...
import com.example.authenticationservice.service.CustomUserDetailService;
...
public class SecurityConfig {
    ...
    private RSAKey loadRSAKey() throws KeyStoreException, IOException, CertificateException, NoSuchAlgorithmException, UnrecoverableKeyException {
        ...
        return new com.nimbusds.jose.jwk.RSAKey.Builder(pubKey).privateKey(privateKey).keyID("auth-server").build();
    }
